...
$.ajax({ url: "events.json" }).done(function(events) {
    var now = Date.now();
    var article = $('<article class="events"><h2>Treffen und Kontakt</h2><p>Wir treffen uns monatlich um gemeinsam an unseren Projekten zu arbeiten, miteinander zu sprechen und interessierte Menschen Willkommen zu heißen. Bitte achtet bei Interesse auch auf den Twitterfeed! Ankündigungen können auch via <a href="http://www.meetup.com/OK-Lab-Dresden">Meetup</a> abboniert werden.</p><p>Alle Fragen können einfach per <a href="https://twitter.com/opendatadresden">Twitter</a>, bei <a href="https://www.meetup.com/OK-Lab-Dresden/">Meetup</a> oder <a href="mailto:rob.tranquillo@gmx.de">per Mail erreichen</a>.</p></article>');
    var ul = $("<ul></ul>");
